            ...
            <div class="fbc_auth_login_box">
                <div class="fbc_login_wrapper">
                    <div class="fbc_login_inner">
                        <h3>Welcome<img src="/images/welcome.png" /></h3>
                        <p>To keep connected with us please login with
                            your registered email and password.</p>
                    </div>
    
                    <form class="fbc_auth_input_wrapper" id="signup_form">
                         <div class="fbc_auth_input">
                            <label class="fbc_main_label">Name</label>
                            <div class="fbc_auth_input_item">
                                <input class="fbc_custom_input" type="text" name="name" id="name" placeholder="Name Here..." required />
