...
//             <div className="ffc-section-heading"></div>
...
//                       </a>
//                       <div className="ffc-tag-product">Live</div>
//                     </div>
...
//                           <path
//                             d="M4.264.789a2 2 0 0 1-2.828 2.828A2 2 0 0 1 4.264.789zm0 6a2 2 0 1 1-2.828 2.828 2 2 0 1 1 2.828-2.828zm0 6a2 2 0 0 1-2.828 2.829 2 2 0 0 1 2.828-2.828z"
//                             fill="#7D809D"
//                           />
//                         </svg>
//                       </div>
...
//                       <button className="ffc-btn ffc-btn-01" onClick={() => toggleProductDetails(product)}>View</button>
//                     </div>
//                   </div>
//                 ))
//               ) : (
...
//                         <input className="ffc-btn ffc"/>
//                         <input className="ffc-btn ffc-btn-01" type="submit" value="Save" />
//                         <input className="ffc-btn ffc-btn-02" type="button" value="Cancel" onClick={toggleModal} />
//                       </div>
//                     </form>
//                   </div>
//                 </div>
...
//                       </div>
//                       <div className="ffc-popup-btn">
//                         <input className="ffc-btn ffc-btn-01" type="button" value="Save" onClick={handleBackButtonClick} />
//                         <input className="ffc-btn ffc-btn-02" type="button" value="Back" onClick={handleBackButtonClick} />
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//           <div className="ffc-modal">
//             <div className="ffc-popup-box ffc-modal-1 popup-box-show">
//               <div className="ffc-over" onClick={() => setProductDetailsOpen(false)}></div>
//               <div className="ffc-popup-wr">
//                 <div className="ffc-popup-full">
//                   <div className="ffc-popup-inner">
//                     <div className="ffc-popup-content">
...
//                       <p><strong>Created On:</strong> {selectedProduct.createdOn}</p>
//                       <p><strong>ID:</strong> {selectedProduct.id}</p>
//                       <div className="ffc-popup-btn">
//                         <input className="ffc-btn ffc-btn-02" type="button" value="Close" onClick={() => setProductDetailsOpen(false)} />
//                       </div>
//                     </div>
//                   </div>
//                 </div>
